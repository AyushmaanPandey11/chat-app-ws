...
function App() {
  ...
  return (
    <div className="h-screen bg-black flex justify-center items-center">
      <div
        className={`flex flex-col justify-center items-center mx-auto border-white border-2 rounded-2xl w-11/12 sm:w-1/3 xl:w-1/3 lg:w-2/5 ${
      ...
      >
        <div className="mx-auto flex h-1/12 sm:h-2/12 w-full text-white justify-center mb-4 sm:mb-4 lg:mb-0">
          <div className="flex flex-col p-4 m-2 w-10/12 space-y-0 sm:space-y-2">
            <div className="text-white flex flex-col justify-center">
              <span className="font-bold text-left text-[2vw] sm:text-[3vw] lg:text-xl mb-0 sm:mb-1 lg:mb-0">
                Real Time Chat
              </span>
        ...
        <div className="mx-auto flex h-10/12 sm:h-9/12 w-full text-white py-1 p-3 m-1 overflow-y-visible mt-3 md:mt-5 lg:mt-4">
          {data.code !== "" ? (
            ...
            <div className="flex justify-center items-center w-full h-full mt-0 sm:mt-0 lg:mt-4">
              <div
                className="bg-gray-200 text-black hover:cursor-pointer w-10/12 flex justify-center items-center rounded-xl sm:text-[3.3vw] text-3xl lg:text-xl 2xl:text-2xl font-bold sm:p-3 p-3 lg:p-3 2xl:p-6"
